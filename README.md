...
<a href="https://aniksarkerakash.com/">
  <img src="./assets/hero.svg" alt="Anik Sarker Akash, System Engineer and AI Solution Developer" width="100%" />
</a>
...
<img src="./assets/flow-build.svg" width="100%" alt="Build loop: discovery, context engineering, AI-assisted scaffold, human review gate, test and harden, ship, measure. Work that reads wrong goes back to context engineering. Measurement feeds the next build." />
...
<img src="./assets/flow-mcp.svg" width="100%" alt="MCP architecture in four layers: the requester, an agent loop driven by a frontier model, four MCP servers over ServiceNow, a SQL warehouse, a filesystem of runbooks and internal APIs, then guardrails for grounded retrieval and audit logging that report back to the loop." />
...
<img src="./assets/flow-print.svg" width="100%" alt="Print deployment sequence: fleet audit, solution design, integration, a pilot on one department, fleet rollout, the custom application that closes the gap the product left, then measurement. A pilot that needs rework returns to solution design, and what gets measured tunes the next site." />
...
- [Nobody nerfed the model. Somebody else answered](https://aniksarkerakash.com/blog/somebody-else-answered)
- [Claude Opus 5.5 is 40% cheaper, if you stop prompting it like Opus 5](https://aniksarkerakash.com/blog/prompting-claude-opus-5-5)
- [The evaluator gets a desk, not a veto](https://aniksarkerakash.com/blog/the-evaluator-gets-a-desk-not-a-veto)
- [The model was never the vulnerability](https://aniksarkerakash.com/blog/the-model-was-never-the-vulnerability)
- [I closed port 3389 for good](https://aniksarkerakash.com/blog/closing-port-3389)
...
<a href="https://aniksarkerakash.com/blog/"><img src="https://img.shields.io/badge/Read_the_blog-7C3AED?style=for-the-badge&logo=hashnode&logoColor=white&labelColor=030014" alt="Blog" /></a>
